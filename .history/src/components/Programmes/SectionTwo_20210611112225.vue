<template>
  <div :class="style.main">
    ...
    <div :class="style.searchContainer">
      ...
      <i :class="[{'fas fa-search':!searchData},{'fa fa-times':!searchData},style.searchIcon]"></i>
      <i v-if="searchData"  @click="clear()" class="style. icon  text-blue-900 text-2xl" aria-hidden="true"></i>
    </div>
