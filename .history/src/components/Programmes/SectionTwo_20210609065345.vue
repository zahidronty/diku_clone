<template>
  <div class="pt-24 pb-24 px-24 flex flex-col h-auto bg-red-50">
    ...
    <div class="flex flex-col w-64">
      ...
      <div class="w-full  py-3 px-2 bg-secondary text-xl text-white mr-3 ">
      <p @click="sort(1)" class="hover:bg-blue-900 ">Application deadline</p>
      <p @click="sort(2)" class="w-full py-3 px-2 bg-secondary text-xl text-white mr-3 hover:bg-blue-900 ">Programe Name</p>
      <p @click="sort(3)" class="w-full py-3 px-2 bg-secondary text-xl text-white mr-3 hover:bg-blue-900 ">Action Name </p>
      </div>
    </div>
