<template>
  <div class="pt-24 pb-24 px-24 flex flex-col h-full bg-red-50">
    ...
    <div class="">
      <input v-model="searchData" class=" relative searchBox absolute z-50 px-6 text-xl m-1 text-blue-500 placeholder-blue-500 py-3 focus:outline-none" placeholder="Search"/>
    ...
    <SectionThree class="mt-32 bg-red-50"/>
  </div>
</template>
