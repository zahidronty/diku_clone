<template>
  <div :class="style.main">
    ...
    <div :class="style.listContainer">
      <div class="">
        <div class="relative mb-2 mr-2 shadow-lg" v-for="programData in programmesData" :key="programData.id">
          <List  
  ...
  export default {
    ...
    data(){
      return{
        ...
        programmesData:[],
        style:{
          main: "relative z-0 pt-24 pb-24 px-24 flex flex-col bg-red-50",
