<template>
  <div class="pt-24 pb-24 px-24 flex flex-col bg-red-50">
    ...
    <div class="relative mt-12 ">
      <input @keypress="search" v-model="searchData" class="searchBox absolute z-50 px-6 text-xl m-1 text-blue-500 placeholder-blue-500 py-3 focus:outline-none" placeholder="Search"/>
