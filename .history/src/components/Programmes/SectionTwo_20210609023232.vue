<template>
  <div class="pt-24 pb-24 px-24 flex flex-col bg-red-50">
    ...
    <div class="relative mt-12 ">
      ...
      <i  class="icon fas fa-search text-blue-900 text-2xl" :class="{ show: !searchData, hide: searchData }"></i>
      <i @keydown="checkingSearchBox" @click="clear()" class="icon fa fa-times text-blue-900 text-2xl" aria-hidden="true" :class="{ show: !searchData, hide: searchData }" ></i>
    </div>
