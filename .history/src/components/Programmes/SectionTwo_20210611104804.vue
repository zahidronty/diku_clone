<template>
  <div :class="style.main">
    ...
    <div :class="style.educationLevelContainer">
      <div :class="style.educationLevel">Elementary school and kindargarten </div>
      <div :class="style.educationLevel">Upper secondary education </div>
      <div :class="style.educationLevel">Adult learning </div>
      <div :class="style.educationLevel">Higher vocational education </div>
      <div :class="style.educationLevel">Higher education </div>
    </div>
    ...
    data(){
      return{
        ...
        style:{
          ...
          educationLevelContainer: "flex flex-wrap text-xl text-white py-3 w-3/4",
          educationLevel: "py-3 px-2 bg-secondary mr-3 mb-4 hover:bg-blue-900",
        }
      } 
    },
    mounted(){
