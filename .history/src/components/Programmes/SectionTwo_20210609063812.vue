<template>
  <div class="pt-24 pb-24 px-24 flex flex-col h-auto bg-red-50">
    ...
    <div class="flex flex-col w-64 hover:bg-blue-900 ">
      <p class="w-full px-2 py-3 bg-secondary text-xl text-white ">Application deadline
        <i class=" text-xl ml-2 fas fa-arrow-down"></i>
      </p>
      <p class="w-full  py-3 px-2 bg-secondary text-xl text-white mr-3 ">Application deadline  </p>
      <p class="w-full py-3 px-2 bg-secondary text-xl text-white mr-3 ">Programe Name</p>
      <p class="w-full py-3 px-2 bg-secondary text-xl text-white mr-3">Action Name </p>
    </div>
