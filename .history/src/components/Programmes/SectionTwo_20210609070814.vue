  ...
  <div class="pt-24 pb-24 px-24 flex flex-col h-auto bg-red-50">
    ...
    <div class="relative z-30 flex flex-col w-64">
      ...
      <div v-if="isSort" class="absolute top-12 z-90 w-full px-2 bg-secondary text-xl text-white mr-3 ">
        <p @click="sort(1)" :class="{orangeSort: sortSelect==1}"  class="py-3 hover:bg-blue-900 ">Application deadline</p>
        <p @click="sort(2)" :class="{orangeSort: sortSelect==2}"  class="py-3 hover:bg-blue-900 ">Programe Name</p>
        <p @click="sort(3)" :class="{orangeSort: sortSelect==3}"  class="py-3 hover:bg-blue-900 ">Action Name </p>
      </div>
    </div>
