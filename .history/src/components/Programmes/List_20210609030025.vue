<template>
 <div class="w-full border-b-2 border-secondary py-2 flex items-center">
  ...
  <div class="1/5 text-right">
  <p class="text-lg font-semibold text-blue-900"> Application deadline 9/24/21</p>
  <span></span>
  </div>
  <i class="w-1/5 text-3xl text-secondary text-right fa fa-arrow-right" aria-hidden="true"></i>
