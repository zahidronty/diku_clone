<template>
  <div class="pt-24 pb-24 px-24 flex flex-col h-auto bg-red-50">
    ...
    <div class="flex flex-col w-64">
      <p class="px-2 py-3 bg-secondary text-xl text-white mb-4">Application deadline
      ...
      <p class="py-3 px-2 bg-secondary text-xl text-white mr-3 ">Programe Name</p>
      <p class="py-3 px-2 bg-secondary text-xl text-white mr-3">Action Name </p>
    </div>
