<template>
  <div class="pt-24 pb-24 px-24 flex flex-col h-auto bg-red-50">
    ...
    <div class="flex flex-col w-64">
      <p class="w-full px-2 py-3 bg-secondary text-xl text-white hover:bg-blue-900 ">{{sortBy}}
        <i class=" text-xl ml-2 fas fa-arrow-down"></i>
      </p>
      <p ref="sortA" @click="sort" value="sad" class="w-full  py-3 px-2 bg-secondary text-xl text-white mr-3 hover:bg-blue-900 ">Application deadline</p>
      <p class="w-full py-3 px-2 bg-secondary text-xl text-white mr-3 hover:bg-blue-900 ">Programe Name</p>
      <p class="w-full py-3 px-2 bg-secondary text-xl text-white mr-3 hover:bg-blue-900 ">Action Name </p>
    </div>

    <div class="relative">
      <input v-model="searchData" class="searchBox absolute z-50 px-6 text-xl text-blue-500 placeholder-blue-500 py-3 focus:outline-none" placeholder="Search"/>
    ...
    <div class="relative mt-24 h-screen">
      <div class="absolute left-3 list mb-2 p-8 bg-white">
        <List class=""/> 
        <List class=""/> 
        <List class=""/> 
        <List class=""/> 
...
<script>
  ...
  export default {
    ...
    methods: {
      ...
      sort(e){
        console.log(this.$refs.sortA.value)
      }
    }
  };
</script>
