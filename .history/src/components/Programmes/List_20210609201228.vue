<template>
 <div @mouseover="isMove=true" @mouseleave="isMove=false" class="w-full border-b-2 border-secondary z-80 px-6 py-2 flex items-center justify-between bg-white">
  ...
  <div class="flex ">
   <p :class="{slash: moment(this.deadline).isAfter(todaysDate) }" class="font-semibold text-blue-900 mr-3"> Application deadline: <span class="text-black"> {{compare}} {{deadline}} </span></p> 
  </div>
