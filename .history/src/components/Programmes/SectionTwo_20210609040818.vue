<template>
  <div class="pt-24 pb-24 px-24 flex flex-col h-auto bg-red-50">
    ...
    <div class="flex flex-col py-3 w-3/4">
      <p class="py-3 px-2 bg-secondary text-xl text-white mr-3 mb-4">Application deadline
        <i class=" text-xl ml-2 fas fa-arrow-down"></i>
      </p>
      <p class="py-3 px-2 bg-secondary text-xl text-white mr-3 mb-4">Application deadline  </p>
      <p class="py-3 px-2 bg-secondary text-xl text-white mr-3 mb-4">Programe Name</p>
      <p class="py-3 px-2 bg-secondary text-xl text-white mr-3 mb-4">Action Name </p>
    </div>
