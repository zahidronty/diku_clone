<template>
  <div :class="style.main">
    ...
    <div class="flex flex-wrap py-3 w-3/4">
      <p :class="style.educationLevel">Artistic research</p>
    </div>
    ...
    data(){
      return{
        ...
        style:{
          ...
          educationLevelContainer: "flex flex-wrap py-3 w-3/4",
          educationLevel: "py-3 px-2 text-xl text-white bg-secondary mr-3 mb-4 hover:bg-blue-900",
        }
      } 
    },
    mounted(){
