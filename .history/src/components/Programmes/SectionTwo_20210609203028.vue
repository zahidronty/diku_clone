<template>
  <div class="just pt-24 pb-24 px-24 flex flex-col bg-red-50">
    ...
    <div class="flex flex-wrap text-xl text-white py-3 w-3/4">
      ...
      <div class="py-3 px-2 bg-secondary mr-3 mb-4">Upper secondary education </div>
      <div class="py-3 px-2 bg-secondary mr-3 mb-4">Adult learning </div>
      <div class="py-3 px-2 bg-secondary mr-3 mb-4">Higher vocational education </div>
      <div class="py-3 px-2 bg-secondary mr-3 mb-4">Higher education </div>
    </div>
