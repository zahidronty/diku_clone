<template>
  <div :class="style.main">
    ...
    <div class="style. flex flex-wrap text-xl text-white py-3 w-3/4">
  ...
  export default {
    ...
    data(){
      return{
        ...
        programmesData:[],
        style:{
          main: "sectionTwo pt-24 pb-24 px-24 flex flex-col bg-red-50",
          info: " w-2/3 font-bold text-2xl text-blue-900",
          label: "mt-8 font-semibold text-xl text-blue-900",
