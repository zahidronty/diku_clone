<template>
  <div class="pt-24 pb-24 px-24 flex flex-col h-auto bg-red-50">
    ...
    <div class="relative mt-24 flex ">
      <div class="mb-12 mr-3 relative z-80">
        <List class=" " v-for="programData in programmesData" :key="programData.id" 
          :title="programData.title"
          :subtitle="programData.subtitle"
          :deadline="programData.deadline"
        /> 
      </div>
      <div class="blueShadow z-2 right-0 bottom-0 bg-blue-900"/>
    </div>
  </div>
</template>
