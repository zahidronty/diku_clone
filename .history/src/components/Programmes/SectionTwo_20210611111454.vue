<template>
  <div :class="style.main">
    ...
    <div :class="style.seachContainer">
      <input v-model="searchData" :class="style.searchInput searchBox absolute z-10 px-6 text-xl text-blue-500 placeholder-blue-500 py-3 focus:outline-none" placeholder="Search"/>
