<template>
  <div class="pt-24 pb-24 px-24 flex flex-col h-auto bg-red-50">
    ...
    <div class="relative mt-24 bg-red-900 w-screen h-screen ">
      <div class="absolute list mr-12 mb-24 p-8 bg-white">
        <List class=""/> 
        <List class=""/> 
        <List class=""/> 
        <List class=""/> 
      ...
      <div class="blueShadow right-0 bg-blue-900">aSasasdasd</div>
