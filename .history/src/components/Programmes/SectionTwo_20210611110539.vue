<template>
  <div :class="style.main">
    ...
    <div :class="style.sortByButtonContainer">
      ...
      <div v-if="isSort" class="style. absolute top-12 z-90 w-full bg-secondary text-xl text-white ">
        <p @click="sortA(1)" :class="{orangeSort: sortSelect==1}"  class="style. py-3 px-2 hover:bg-blue-900 ">Application deadline</p>
        <p @click="sortA(2)" :class="{orangeSort: sortSelect==2}"  class="style. py-3 px-2 hover:bg-blue-900 ">Programe Name</p>
