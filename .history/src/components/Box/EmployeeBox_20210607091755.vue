...
<div class="relative h-48 mx-2">
   ...
   <div class="flex focus:outline-none ml-1 mainLeft mainRight text-left bg-white ring-4 ring-blue-900 mr-3 px-8" 
    :class="{ expandMainLeft: isExpandLeft, expandMainRight: isExpandRight, main:!isExpandLeft, main:!isExpandRight  ,shadow:!isExpand }" 
   >
