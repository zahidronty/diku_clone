<template>
  <div :class="style.main">
    ...
    <div :class="[style.mainBoxContainer, { expandMainLeft: isExpandLeft, expandMainRight: isExpandRight}]">
      <img class="style.proPic mr-6 mb-4 w-32 justify-center" :src= picture />
      <div class="style. h-full">
       ...
       <p class="style. text-lg font-bold text-blue-900 mb-1">{{position}}</p>
       <div :class="{ show: isExpand, hide: !isExpand }" >
        <p class="style. text-secondary font-medium text-lg"> {{phone}} </p>
        <p class="style. text-secondary font-medium text-lg"> {{email}} </p>
       </div>
       <div 
