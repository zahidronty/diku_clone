...
<div class="relative h-48 mx-2">
   ...
   <button class="focus:outline-none buttons absolute text-left bg-white ring-4 ring-blue-900 mr-3 px-8">
     <div class="flex w-full">
      <img class="mr-6 mb-4 w-1/4 justify-center" :src= picture />
      <div class="h-full px-3">
       <p class="text-2xl font-bold text-blue-900">{{firstName}} <span>{{lastName}}</span></p>
       ...
       <p class="text-lg inline underline text-secondary font-bold" :class="{ expand: isExpand }"
