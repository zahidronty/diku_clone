<template>
  ...
  >
    <div :class="[style.shadow,{'bottom-0':topBottom,'top-0':!topBottom, 'right-0':rightLeft, 'left-0':!rightLeft}]"/>
    <button :class="[{'bottom-0':!topBottom, 'top-0':topBottom, 'right-0':!rightLeft, 'left-0':rightLeft},style.mainBox]">
...
<script>
  export default {
    name: "Box",
    props: ['primary', 'secondary', 'tertiary', 'right', 'left','top', 'topBottom'],
    data() {
      return {
        isActive: false,
        top:false,
        ...
        style:{
          ...
          mainBox:"buttons absolute text-left text-3xl bg-white ring-4 ring-blue-900 ml-3 px-8",
