<template>
  ...
  >
    <div :class="[style.shadow,{'bottom-0':bottom=true, 'top-0':top=true}]"/>
    <button :class="[{'bottom-0':top=true,'top-0':bottom=bottom=true,'right-0':right=true,'left-0':left=true},style.mainBox]">
