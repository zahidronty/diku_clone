<template>
  ...
  >
    ...
    <button :class="[{'bottom-0':top=true,'top-0':bottom=true,'right-0':right=true,'left-0':left=true},style.mainBox]">
    ...
    data() {
      return {
        ...
        style:{
          ...
          mainBox:"buttons absolute text-left text-3xl bg-white ring-4 ring-blue-900 mt-3 ml-3 px-8",
