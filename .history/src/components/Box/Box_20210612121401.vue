<template>
  ...
  >
    <div :class="[style.shadow,{'bottom-0':topBottom,'top-0':!topBottom}]"/>
    <button :class="[{'bottom-0':!topBottom, 'top-0':topBottom, 'right-0':right=true,'left-0':left=true},style.mainBox]">
