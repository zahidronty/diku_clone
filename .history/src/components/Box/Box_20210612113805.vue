<template>
  ...
  >
    <div :class="[style.shadow,{'bottom-0':bottom=true, 'top-0':bottom=false}]"/>
    <button :class="[{'bottom-0':bottom=false, 'top-0':bottom=falsetrue,'right-0':right=true,'left-0':left=true},style.mainBox]">
...
<script>
  export default {
    name: "Box",
    props: ['primary', 'secondary', 'tertiary', 'right', 'left', 'top', 'bottom'],
    data() {
      return {
        isActive: false,
        top:false,
