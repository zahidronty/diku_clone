<template>
  ...
  >
    <div :class="[style.shadow,{'bottom-0':bottom, 'top-0':top}]"/>
    <button :class="[{'top-0':bottom=false, 'bottom-0':bottom=true,'right-0':right=true,'left-0':left=true},style.mainBox]">
