   ...
   >
     <div class="flex w-full">
      ...
      <div class="h-full px-3">
       ...
       <div class="text-lg inline underline text-secondary font-bold mb-3" 
        @mouseover="isActive = true"
        @mouseleave="isActive = false"
        @click ="expand"
         :class="{ hide: isExpandLeft, hide: isExpandRight , show: !isExpandLeft,  show: !isExpandRight  }"
       >
        More information
