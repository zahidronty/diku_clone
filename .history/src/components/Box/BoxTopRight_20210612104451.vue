<template>
  ...
  >
    <div :class="[style.shadow,{'bottom-0':topBottom=="bottom"}]"></div>
    ...
    data() {
      return {
        ...
        style:{
          ...
          mainBox:"buttons absolute right-0 text-left font-semibold text-3xl bg-white ring-4 ring-blue-900 ml-3 px-8",
