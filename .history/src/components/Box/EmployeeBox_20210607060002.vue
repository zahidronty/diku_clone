...
<div class="relative h-48 mx-2">
   ...
   >
     ...
     <div   >
      <i @click="shrink"  class="fa fa-times text-5xl text-blue-900" :class="{ show: isExpandLeft, show: isExpandRight , hide: !isExpandLeft, hide:!isExpandRight }"  aria-hidden="true"></i>
     </div>
   </button>
  </div>
</template>
