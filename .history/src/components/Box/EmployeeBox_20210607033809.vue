...
<div class="relative h-48 mx-2">
   <div class="shadows absolute right-0 bottom-0 bg-blue-900" :class="{ expandShadow: isExpand }"/>
   <button class="focus:outline-none buttons absolute text-left bg-white ring-4 ring-blue-900 mr-3 px-8" 
    :class="{ expandMainLeft: isExpandLeft }" :class="{ expandMainRight: isExpandRight }"
   >
