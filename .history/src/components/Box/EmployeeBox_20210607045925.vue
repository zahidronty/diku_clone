...
<div class="relative h-48 mx-2">
   ...
   >
     ...
     <div class="opacity-100" :class="{ showIcon: isExpandLeft || isExpandRight }"  >
      <i @click="shrink" :class="{ showIcon: isExpandLeft || isExpandRight }" class=" fa fa-times text-5xl text-blue-900" aria-hidden="true"></i>
     </div>
   </button>
  </div>
</template>
