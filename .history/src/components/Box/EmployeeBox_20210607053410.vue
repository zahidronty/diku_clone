...
<div class="relative h-48 mx-2">
   ...
   >
     <div class="flex w-full">
      ...
      <div class="h-full px-3">
       ...
       <p class="text-lg inline underline text-secondary font-bold" 
        ...
        @click ="expand"
         :class="{ showIcon: isExpandLeft || isExpandRight , hide: !isExpandLeft || isExpandRight  }"
       >
        More information
     ...
     <div   >
      <i @click="shrink"  class="fa fa-times text-5xl text-blue-900" :class="{ showIcon: isExpandLeft || isExpandRight , hide: !isExpandLeft || isExpandRight }"  aria-hidden="true"></i>
     </div>
   </button>
  </div>
</template>
