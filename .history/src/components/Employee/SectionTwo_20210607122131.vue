 ...
 <div class="w-screen h-full bg-red-50 py-8">
    <div class="pt-8 px-24">
     ...
     <div class="relative">
      ...
      <i class="icon fas fa-search text-blue-900 text-2xl" :class="{ show: isExpand, hide: !isExpand }"></i>
      <i class="fa fa-times" aria-hidden="true" :class="{ show: isExpand, hide: !isExpand }"></i>
     </div>
    </div>
