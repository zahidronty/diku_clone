 ...
 <div class="w-screen h-full bg-red-50 py-8">
    <div class="pt-8 px-24">
     ...
     <ul class="absolute z-50 bg-white w-full" :class="{showSuggestion: isSuggest, hideSuggestion: !isSuggest }"  >
       <li class="m-6 border-b-4 border-secondary text-secondary text-lg font-semibold pl-6 " @click="suggestSelected" v-for="department in departments" :key="department">{{department}}</li>
      </ul>
     </div>
