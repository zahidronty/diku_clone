   ...
   export default {
      ...
      return {
            ...
            style:{
               ...
               searchInput: "searchBox absolute px-6 z-5 text-xl m-1 text-blue-500 placeholder-blue-500 py-3 focus:outline-none",
               searchSuggestionList:"absolute top-0 pt-16 z-2 pb-3 bg-white w-full border-2 border-blue-900",
               searchSuggestionElement:"mx-6 border-b-2 border-secondary text-secondary text-lg font-semibold pl-6",
               searchIcon:"icon absolute z-10 fas fa-search text-blue-900 text-2xl",
