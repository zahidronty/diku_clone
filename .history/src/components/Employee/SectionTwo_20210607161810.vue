<template>
 <div class="w-screen h-full bg-red-50 py-8">
    <div class="pt-8 px-24">
     ...
     <div class="relative">
      <input @click="departmentsSort" v-model="searchData" :class="{showSuggestion: isSuggest, hideSuggestion: !isSuggest }"   class="w-full mt-12 px-6 text-xl text-blue-500 placeholder-blue-500 py-3 focus:outline-none" placeholder="Search by name, department and work area"/>
     ...
     <ul class="absolute z-50 pb-3 bg-white w-full border-2 border-blue-900" :class="{showSuggestion: isSuggest, hideSuggestion: !isSuggest }"  >
    ...
    <div class="flex flex-wrap mt-24 px-24">
