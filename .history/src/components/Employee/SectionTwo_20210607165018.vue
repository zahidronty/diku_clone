 ...
 <div class="w-screen h-full bg-red-50 py-8">
    <div class="pt-8 px-24">
     ...
     <div class="relative mt-12 ">
      ...
      <ul class="absolute top-0 pt-24 z-30 pb-3 bg-white w-full border-2 border-blue-900" :class="{showSuggestion: isSuggest, hideSuggestion: !isSuggest }"  >
   ...
   <button @click="more" :class="{ hideMore:!isMore, showMore: isMore}" class="focus:outline-none w-screen text-center text-xl text-blue-900 ">
...
<script>
 ...
 export default {
  ...
  methods: {
   ...
   more(){
    let arrayLength = this.filteredUser.length
