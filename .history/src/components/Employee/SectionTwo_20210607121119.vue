...
<div class="w-screen h-full bg-red-50 py-8">
  ...
  <div class="py-4 w-1/2" v-for="user in filteredUsers.slice(0, 10)" :key="key">
   <EmployeeBox 
  ...
  <div class="w-screen text-center text-xl text-blue-900 ">
  <div class="font-semibold">View More</div>
  <i class=" text-2xl motion-safe:animate-bounce fas fa-arrow-down"></i>
 </div>
  </div>
</div>
</template>
