  ...
  computed: {
   filteredUsers(){
    ...
    if (!this.searchData){
     ...
     let searchByFirstName = resultDepartment.concat(this.users.filter(user => user.first_name.match(this.searchData)));
     let searchByLasttName = searchByFirstName.concat(this.users.filter(user => user.first_name.match(this.searchData)));
