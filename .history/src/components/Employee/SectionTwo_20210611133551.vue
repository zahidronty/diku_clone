   ...
   export default {
      ...
      return {
            ...
            style:{
               ...
               searchInput: "searchBox absolute z-10 px-6 text-xl m-1 text-blue-500 placeholder-blue-500 py-3 focus:outline-none",
               ...
               searchIcon:"icon absolute z- fas fa-search text-blue-900 text-2xl",
