<template>
 <div class="w-screen h-full bg-red-50 py-8">
    <div class="pt-8 px-24">
     ...
     <div class="relative mt-12 ">
      ...
      <ul v-if="isSuggest" class="absolute top-0 pt-24 z-30 pb-3 bg-white w-full border-2 border-blue-900" >
       <li class="mx-6 border-b-2 border-secondary text-secondary text-lg font-semibold pl-6 " @click="suggestSelected" v-for="department in departments" :keys="department">{{department}}</li>
      </ul>
   ...
   <div class="py-4 w-1/2" v-for="user in filteredUsers.slice(0, this.userLimit)" :key="this.keys">
    <EmployeeBox 
