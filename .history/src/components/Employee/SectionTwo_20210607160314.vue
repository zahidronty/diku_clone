<template>
 <div class="w-screen h-full bg-red-50 py-8">
    <div class="pt-8 px-24">
     ...
     <ul :class="{showSuggestion: isSuggest}"  >
       <li @click="suggestSelected" value="sdf" v-for="department in departments" :key="department">{{department}}</li>
      </ul>
     </div>
...
<script>
 ...
 export default {
  ...
  suggestSelected(e){
   console.log(e)
   console.log(e.srcElement.childNodes[0].text)
   this.searchData = e.srcElement.childNodes[0].text;
  }
  }  
 };
</script>
