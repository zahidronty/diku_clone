  ...
  computed: {
   filteredUsers(){
    ...
    if (!this.searchData){
     ...
     let resultDepartment = this.users.filter(user => user.department.match(this.searchData))
     let resultFirstName = this.users.filter(user => user.first_name.match(this.searchData))
     
     let refinedResult = result.push(this.users.filter(user => user.first_name.match(this.searchData)))
