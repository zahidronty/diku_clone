 ...
 <div class="w-screen h-full bg-red-50 py-8">
    <div class="pt-8 px-24">
     ...
     <div class="relative mt-12">
      <input @click="departmentsSort" v-model="searchData" class="absolute right-3 bg-red-600 w-full z-50 px-6 text-xl m-12 text-blue-500 placeholder-blue-500 py-3 focus:outline-none" placeholder="Search by name, department and work area"/>
