 ...
 <div class="w-screen h-full bg-red-50 py-8">
    <div class="pt-8 px-24">
     ...
     <div class="relative mt-12 ">
      ...
      <ul @mouseover="console.log("hello")" ref="suggestList" class="absolute top-0 pt-24 z-30 pb-3 bg-white w-full border-2 border-blue-900" :class="{show: isSuggest, hide: !isSuggest }"  >
