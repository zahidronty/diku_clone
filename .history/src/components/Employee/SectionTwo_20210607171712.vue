 ...
 <div class="w-screen h-full bg-red-50 py-8">
    <div class="pt-8 px-24">
     ...
     <div class="relative mt-12 ">
      ...
      <i class="mt-24 absolute bottom-0 icon fas fa-search text-blue-900 text-2xl" :class="{ show: !isSearch, hide: isSearch }"></i>
      <i @click = "this.searchData=''" class="absolute bottom-0 icon fa fa-times text-blue-900 text-2xl" aria-hidden="true" :class="{ show: isSearch, hide: !isSearch }"></i>
     </div>
    </div>
