    ...
    <div class="relative mt-24 ml-2 pb-2 pr-1 ">
        ...
        <div class="mainBox shadow-lg">
          <div class="py-6 text-xl relative bg-white ring-4 ring-blue-900">
            <div @click="accordion(1)" class="flex justify-between items-center mx-6 mt-6 py-4 px-3 border-blue-900 border-t-2 border-b-2">
              <p class="">Right of Appeal</p>
              <i class="text-2xl fas fa-chevron-down"></i>
            </div>
            <div v-if="accordionState==1" class="bg-blue-200 px-10">{{rightsOfAppeal}}</div>

            <div @click="accordion(2)" class="flex justify-between items-center mx-6 py-4 px-3 border-blue-900 border-b-2">
              <p class="">Public information and rights of access</p>
              <i class="text-2xl fas fa-chevron-down"></i>
            </div>
            <div v-if="accordionState==2" class="bg-blue-100 px-10">{{rightsOfAppeal}}</div>
            ...
            <div v-if="accordionState==3" class="bg-blue-200 px-10">{{rightsOfAppeal}}</div>
