...
<div class="w-2/5 pr-12 ">
  <ul class="sticky top-0 flex flex-col text-xl font-semibold  ">
   <li :class="{"active font-bold" : activeSection==1}" class="border-b-4 py-2 border-blue-900 mb-4">Who Can Apply?<i :class="{rotate : activeSection==1}" class="origin-center transform rotate-45 fa fa-arrow-right ml-4" aria-hidden="true"></i></li>
