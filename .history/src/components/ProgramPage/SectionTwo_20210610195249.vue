    ...
    <div class="relative mt-24 ml-2 pb-2 pr-1 ">
        ...
        <div class="mainBox shadow-lg">
          <div class="py-6 text-xl relative bg-white ring-4 ring-blue-900">
            ...
            <div v-if="accordionState==1" :class="{activeAccordion: accordionState==1}" class="bg-blue-200 px-10 py-4">{{rightsOfAppeal}}</div>
            ...
            <div @click="accordion(3)" :class="{activeAccordion: accordionState==3}" class="flex justify-between items-center mx-6 py-4 px-3 border-blue-900 ">
