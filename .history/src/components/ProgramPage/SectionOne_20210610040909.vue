<template>
 <div class="relative pt-12 px-24 bg-white ">
    <div class="h-full flex flex-col justify-between">
      <Header class="z-50" @modal="modal"/>
        <p class="my-12 text-2xl text-secondary font-semibold">Programmes</p>
        <p class="mt-24 font-semibold text-5xl text-blue-900 mb-3"> {{title}} </p>
