...
<div class="w-2/5 pr-12 ">
  ...
  <div class="w-3/5 ml-2 mt-5 leading-normal whitespace-pre-line">
    ...
    <div class="relative mt-24 ml-2 pb-2 pr-1 ">
        ...
        <div class="mainBox shadow-lg">
          <div class="p-6 text-xl relative bg-white ring-4 ring-blue-900">
            <div class="flex justify-between items-center mt-6 py-4 px-3 border-blue-900 border-t-2 border-b-2">
              <p class="">Right of Appeal</p>
              <i class="text-2xl fas fa-chevron-down"></i>
            </div>

            <div class="flex justify-between items-center py-4 px-3 border-blue-900 border-b-2">
              <p class="">Public information and rights of access</p>
              <i class="text-2xl fas fa-chevron-down"></i>
            </div>

            <div class="flex justify-between items-center py-4 px-3 border-blue-900 ">
