...
<div class="w-2/5 pr-12 ">
  <ul class="sticky top-0 flex flex-col text-xl font-light text-blue-900  ">
   <li :class="{active : activeSection==1}" class="deactive border-b-4 py-2 border-blue-900 mb-4">Who Can Apply?<i :class="{rotate : activeSection==1}" class="origin-center transform rotate-45 fa fa-arrow-right ml-4" aria-hidden="true"></i></li>
   <li :class="{active : activeSection==2}" class="deactive border-b-4 py-2 border-blue-900 mb-4">What can you apply for?<i :class="{rotate : activeSection==2}" class="origin-center transform rotate-45 fa fa-arrow-right ml-4" aria-hidden="true"></i></li>
   <li :class="{active : activeSection==3}" class="deactive border-b-4 py-2 border-blue-900 mb-4">How do you apply?<i :class="{rotate : activeSection==3}" class="origin-center transform rotate-45 fa fa-arrow-right ml-4" aria-hidden="true"></i></li>
   <li :class="{active : activeSection==4}" class="deactive border-b-4 py-2 border-blue-900 mb-4">How do you report? <i :class="{rotate : activeSection==4}" class="origin-center transform rotate-45 fa fa-arrow-right ml-4" aria-hidden="true"></i></li>
   <li :class="{active : activeSection==5}" class="deactive border-b-4 py-2 border-blue-900 mb-4">Applicant Seminar 2019 <i :class="{rotate : activeSection==5}" class="origin-center transform rotate-45 fa fa-arrow-right ml-4" aria-hidden="true"></i></li>
  </ul>
  </div>
