...
<div class="w-2/5 pr-12 ">
  ...
  <div class="w-3/5 mt-5 leading-normal whitespace-pre-line">
   ...
   <div class="pb-12">
    ...
    <div class="relative mt-24 pb-2 pr-1 ">
        <div class="blueShadow bg-blue-900"/>
        <div class="mainBox shadow-lg">
          <div class="p-6 text-xl relative bg-white ring-4 ring-blue-900">
            <div @click="accordion(1)" class="flex justify-between items-center mt-6 py-4 px-3 border-blue-900 border-t-2 border-b-2">
              <p class="">Right of Appeal</p>
              <i class="text-2xl fas fa-chevron-down"></i>
            </div>
            <div class="bg-blue-200">ads</div>

            <div @click="accordion(2)" class="flex justify-between items-center py-4 px-3 border-blue-900 border-b-2">
              <p class="">Public information and rights of access</p>
              <i class="text-2xl fas fa-chevron-down"></i>
            </div>

            <div @click="accordion(3)" class="flex justify-between items-center py-4 px-3 border-blue-900 ">
