...
<div class="w-2/5 pr-12 ">
  <ul class="sticky top-0 flex flex-col text-xl font-light">
   <li :class="{active : activeSection==1 }" class="deactive text-purple-400 border-purple-400 border-b-4 py-2 mb-4 flex justify-end">Who Can Apply?<i :class="{rotate : activeSection==1}" class="origin-center transform rotate-45 fa fa-arrow-right ml-4" aria-hidden="true"></i></li>
   <li :class="{active : activeSection==2}" class="deactive text-purple-400 border-purple-400 border-b-4 py-2 mb-4">What can you apply for?<i :class="{rotate : activeSection==2}" class="origin-center transform rotate-45 fa fa-arrow-right ml-4" aria-hidden="true"></i></li>
