 ...
 <div class="sectionTwo px-24 pt-12 bg-gray-100 h-full flex pb-24">
  ...
  <div class="w-2/5 pr-12 ">
    <ul class="sticky top-0 flex flex-col text-xl font-light">
      <li :class="[style.sidebar, {active : activeSection==1}]"><p class="">Who can apply?</p><i :class="{rotate : activeSection==1}" class="origin-center transform rotate-45 fa fa-arrow-right" aria-hidden="true"></i></li>
      <li :class="[style.sidebar, {active : activeSection==2}]"><p class="text-left">What can you apply for?</p><i :class="{rotate : activeSection==2}" class="origin-center transform rotate-45 fa fa-arrow-right ml-4" aria-hidden="true"></i></li>
      <li :class="[style.sidebar, {active : activeSection==3}]">How do you apply?<i :class="{rotate : activeSection==3}" class="origin-center transform rotate-45 fa fa-arrow-right ml-4" aria-hidden="true"></i></li>
      <li :class="[style.sidebar, {active : activeSection==4}]">How do you report? <i :class="{rotate : activeSection==4}" class="origin-center transform rotate-45 fa fa-arrow-right ml-4" aria-hidden="true"></i></li>
      <li :class="[style.sidebar, {active : activeSection==5}]">Applicant Seminar 2019 <i :class="{rotate : activeSection==5}" class="origin-center transform rotate-45 fa fa-arrow-right ml-4" aria-hidden="true"></i></li>
      <li :class="[style.sidebar, {active : activeSection==6}]">Legal Information <i :class="{rotate : activeSection==6}" class="origin-center transform rotate-45 fa fa-arrow-right ml-4" aria-hidden="true"></i></li>
    </ul>
  </div>
...
<script>
  ...
  export default {
    ...
    data(){ return{
        ...
        accordionState:0,
        style:{
          sidebar: "w-4/5 text-purple-400 border-purple-400 border-b-2 py-2 mb-4 flex flex-wrap justify-between"},
