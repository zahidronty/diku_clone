 ...
 <div class="sectionTwo px-24 pt-12 bg-gray-100 h-full flex pb-24">
  ...
  <div class="w-2/5 pr-12 ">
    <ul class="sticky top-0 flex flex-col text-xl font-light">
      ...
      <li :class="[style.sidebar.text, {active : activeSection==4}]">How do you report? <i :class="[style.sidebar.icon, {rotate : activeSection==1}]" aria-hidden="true"></i></li>
      <li :class="[style.sidebar.text, {active : activeSection==5}]">Applicant Seminar 2019 <i :class="[style.sidebar.icon, {rotate : activeSection==1}]" aria-hidden="true"></i></li>
      <li :class="[style.sidebar.text, {active : activeSection==6}]">Legal Information <i :class="[style.sidebar.icon, {rotate : activeSection==1}]" aria-hidden="true"></i></li>
    </ul>
  </div>
