 ...
 <div class="sectionTwo px-24 pt-12 bg-gray-100 h-full flex pb-24">
  ...
  <div class="w-2/5 pr-12 ">
    <ul class="sticky top-0 flex flex-col text-xl font-light">
      <li :class="{active : activeSection==1 }" class=""><p class="">Who Can Apply?</p><i :class="{rotate : activeSection==1}" class="origin-center transform rotate-45 fa fa-arrow-right" aria-hidden="true"></i></li>
