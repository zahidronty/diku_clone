<template>
 <div class="relative px-24 pt-12 bg-gray-100 h-full flex pb-24">
  ...
  <ul class="sticky top-0 w-2/5 pr-12 flex flex-col text-xl font-semibold  ">
   <li :class="{active : activeSection==1}" class="border-b-4 py-2 border-blue-900 mb-4">Who Can Apply?<i class="fa fa-arrow-right ml-4" aria-hidden="true"></i></li>
