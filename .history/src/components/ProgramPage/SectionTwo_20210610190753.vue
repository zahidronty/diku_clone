   ...
   <div class="pb-12">
    ...
    <div class="relative mt-24 ml-2 pb-2 pr-1 ">
        ...
        <div class="mainBox shadow-lg">
          <div class="p-6 relative bg-white ring-4 ring-blue-900">
            <p class="font-semibold text-xl mb-4 ">Rights of Appeal</p>
            <p class="font-semibold text-xl mb-4 ">Public information
               and rights of access</p>
            <p class="font-semibold text-xl mb-4 ">Conflicts of interest</p>
          </div>
        </div>
      </div>
    </div>
