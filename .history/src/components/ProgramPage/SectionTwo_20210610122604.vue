...
<div class="w-2/5 pr-12 ">
  <ul class="sticky top-0 flex flex-col text-xl font-light">
    ...
    <li :class="{active : activeSection==6}" class="w-4/5 text-purple-400 border-purple-400 border-b-2 py-2 mb-4 flex flex-wrap justify-between">Legal Information <i :class="{rotate : activeSection==5}" class="origin-center transform rotate-45 fa fa-arrow-right ml-4" aria-hidden="true"></i></li>
  </ul>
  </div>
  ...
  <div class="w-3/5 mx-8  mt-5 leading-normal whitespace-pre-line">
   ...
   <div class="pb-12">
    <p ref="applicantSeminar" class="text-4xl text-blue-900 font-semibold mb-6">Legal Information</p>
    <p class="text-xl font-regular" v-html="legalInformation">  </p>
   </div>
  </div>
 </div>  
</template>
