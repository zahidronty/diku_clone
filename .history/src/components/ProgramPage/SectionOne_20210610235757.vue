<template>
  <div :class="style.main">
    ...
    <p class="style. px-24 mb-24 text-2xl leading-relaxed font-normal tracking-wider w-2/3"> {{info}} </p>
    <p :class="[style.,{slash:isOver}]" class="mb-12 px-24 text-xl text-blue-900 font-semibold"> Application deadline: <span class="text-black"> {{moment(deadline).format("MMMM DD, YYYY")}} within 12:00 PM </span> </p>
  </div>  
</template>
