...
<div class="w-2/5 pr-12 ">
  <ul class="sticky top-0 flex flex-col text-xl font-light">
   ...
   <li :class="{active : activeSection==5}" class="deactive text-purple- border-purple-400 border-b-4 py-2 mb-4">Applicant Seminar 2019 <i :class="{rotate : activeSection==5}" class="origin-center transform rotate-45 fa fa-arrow-right ml-4" aria-hidden="true"></i></li>
  </ul>
  </div>
