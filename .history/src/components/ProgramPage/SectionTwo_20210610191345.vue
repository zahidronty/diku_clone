    ...
    <div class="relative mt-24 ml-2 pb-2 pr-1 ">
        ...
        <div class="mainBox shadow-lg">
          <div class="p-6 text-xl relative bg-white ring-4 ring-blue-900">
            <p class="mb-4 py-4 px-3 border-blue-900 border-t-2 border-b-2">Right of Appeal</p>
            <p class="mb-4 py-4 px-3 border-blue-900 border-b-2">Public information and rights of access</p>
            <p class="mb-4 py-4 px-3">Conflicts of interest</p>
          </div>
        </div>
      </div>
    </div>
