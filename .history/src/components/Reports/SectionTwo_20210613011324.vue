<template>
  <div :class="style.main">
   <div :class="style.inputContainer">
    ...
    <div :class="style.sortByButtonContainer">
      <p @click="isSortYear=true" :class="style.sortByButton">{{sortByPublication}}<i :class="style.sortIcon"/></p>
      <div v-if="isSortYear" :class="style.sortOptionContainer">
        <div :class="style.list" v-for="publication of publications" :key="publication">
         <p @click="sortYear(year)" :class="[style.sortOption,{orangeSort: sortSelect==publication}]">{{publication}}</p>
        </div>
      </div>
    </div>
