  ...
  export default {
    ...
    data(){
      return{
        ...
        programmesData:[],
        style:{
          main: "relative z-10 pt-12 pb-24 flex flex-col bg-red-50",
          inputContainer: "flex",
          sortByButtonContainer: "flex flex-col w-1/3 py-3",
          sortByButton: "px-2 py-3 bg-secondary text-xl text-white hover:bg-blue-900",
          ...
          searchInput: "px-6 text-xl text-blue-500 placeholder-blue-500 py-3 focus:outline-none",
