<template>
  <div :class="style.main">
    ...
    <div class="relative">
      <div class="h-5/6 w-5/6 absolute left-0 bottom-0 bg-blue-900"/>
      <div class="bg-white absolute w-5/6 h-5/6 ">
        Hello asdasd
      </div>
    </div>

    
    <div class="relative w-screen my-24">
      <div class="w-1/2 mb-24">
        <Box class="absolute z-90 bg-blue-50"
          :props = "{
    ...
    <div class="relative">
      <div class="bg-secondary w-1/2 h-1/2"></div>
    </div>
  ...
  export default {
    ...
    data(){
      return{
        ...
        searchData: '',
        style:{
          main: "pt-24 px-24 flex flex-col bg-red-50",
