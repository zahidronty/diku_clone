<template>
  <div class="relative w-full h-full bg-white mb-6">
    <div class="shadows absolute bottom-0 bg-blue-900">AS</div>
    <div class="absolute ml-4 flex flex-col bg-blue-400 text-left font-normal">
