<template>
  <div class="relative w-full bg-white h-full mb-6 pb-4">
    <div class="hello mb-4 ml-4 bg-red-50 flex flex-col text-left font-normal">
    ...
    <div class="shadow absolute bottom-0 left-0 bg-blue-900">asd</div>
  </div>
</template>
