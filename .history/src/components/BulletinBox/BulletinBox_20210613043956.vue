<template>
  <div :class="[style.main,{'flex-row-reverse':props.picLeftRight=='left'}]">
    ...
    <img v-if="props.pic==true" :class="[style.image,{'right-3':props.picLeftRight=='right','left-5':props.picLeftRight=='left'}]" :src="require('@/assets/' + props.picName)"/>
  </div>
</template>
