<template>
  <button class="mt-12 mx-24 bg-blue-900 relative relative w-full h-full mb-12">
    <div class="shadows absolute bottom-0 bg-blue-900"></div>
    <div class="buttons absolute right-0 text-left font-normal ring-4 ring-blue-900 ml-3">
