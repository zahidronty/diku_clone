<template>
  <div class="relative w-full bg-white h-full mb-6">
    <div class="main absolute top-0 mb-4 ml-4 flex flex-col text-left font-normal">
    ...
    <div class="borders absolute bottom-0 bg-blue-900">asd</div>
  </div>
</template>
