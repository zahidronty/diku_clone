<template>
  <div class="relative bg-green-300 p-2">
    <div class="borders bg-blue-200 z-0"></div>
    <div class="w-full h-full bg-white z-10">
      <div class="main h-full mb-3 ml-4 text-left font-normal">
